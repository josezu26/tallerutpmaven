                        ...
                        <c:forEach var="repuesto" items="${listaRepuestos}">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-footer">
                                    <a href="ControladorTecnico?accion=agregarRepuestoCarrito&codigoRepuesto=${repuesto.getCodigoRepuesto()}&codigoHojaServicio=${codigoHojaServicio}" class="btn btn-primary">Agregar</a>
                                    <a href="ControladorTecnico?accion=eliminarRepuestoCarrito&codigoRepuesto=${repuesto.getCodigoRepuesto()}&codigoHojaServicio=${codigoHojaServicio}" class="btn btn-danger">Quitar</a>
                                </div>
                            </div>
                        </c:forEach>
                        </div>
