        ...
        <main class="contenido">
            ...
            <div class="principal">
                <div class="general">
                    ...
                    <form class="formulario" action="ControladorTecnico">
                        ...
                        <label class="form-label" for="codigoCliente:">Codigo del Cliente</label><br>
                        <input type="number" name="codigoCliente"><br>
